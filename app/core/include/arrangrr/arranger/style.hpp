...
enum class SectionType : std::uint8_t {
  kIntro1 = 0, kIntro2 = 1,
  kVarA = 2, kVarB = 3, kVarC = 4, kVarD = 5,
  kFillA = 6, kFillB = 7, kFillC = 8, kFillD = 9,
  kBreak = 10,
  kEnding1 = 11, kEnding2 = 12,
};
...
constexpr bool section_is_intro(SectionType t) noexcept {
  return t <= SectionType::kIntro2;
}
constexpr bool section_is_ending(SectionType t) noexcept {
  return t >= SectionType::kEnding1;
}
...
inline constexpr StyleEvent kVarADrums[] = {
    {0, 36, 0, 110, 120},  {4, 38, 0, 100, 120},  {8, 36, 0, 105, 120},
    {12, 38, 0, 100, 120}, {0, 42, 0, 70, 60},    {2, 42, 0, 60, 60},
    {4, 42, 0, 70, 60},    {6, 42, 0, 60, 60},    {8, 42, 0, 70, 60},
    {10, 42, 0, 60, 60},   {12, 42, 0, 70, 60},   {14, 42, 0, 60, 60},
};
...
inline constexpr StyleEvent kVarBDrums[] = {
    {0, 36, 0, 115, 120}, {4, 38, 0, 105, 120}, {7, 36, 0, 90, 120},
    {8, 36, 0, 110, 120}, {12, 38, 0, 105, 120},
    {0, 42, 0, 75, 50},   {1, 42, 0, 55, 50},   {2, 42, 0, 65, 50},
    {3, 42, 0, 55, 50},   {4, 42, 0, 75, 50},   {5, 42, 0, 55, 50},
    {6, 42, 0, 65, 50},   {7, 42, 0, 55, 50},   {8, 42, 0, 75, 50},
    {9, 42, 0, 55, 50},   {10, 42, 0, 65, 50},  {11, 42, 0, 55, 50},
    {12, 42, 0, 75, 50},  {13, 42, 0, 55, 50},  {14, 42, 0, 65, 50},
    {15, 42, 0, 55, 50},
};
...
inline constexpr StyleEvent kVarBChord[] = {
    {2, 0, 0, 78, 200},  {2, 1, 0, 78, 200},  {2, 2, 0, 78, 200},
    {6, 0, 0, 72, 200},  {6, 1, 0, 72, 200},  {6, 2, 0, 72, 200},
    {10, 0, 0, 78, 200}, {10, 1, 0, 78, 200}, {10, 2, 0, 78, 200},
    {14, 0, 0, 72, 200}, {14, 1, 0, 72, 200}, {14, 2, 0, 72, 200},
};
...
inline constexpr StyleEvent kIntroDrums[] = {
    {8, 42, 0, 60, 60}, {10, 42, 0, 65, 60}, {12, 42, 0, 70, 60}, {14, 42, 0, 80, 60},
};
...
inline constexpr StyleEvent kEndDrums[] = {
    {0, 36, 0, 115, 120}, {0, 49, 0, 110, 1800},
};
inline constexpr StyleEvent kEndBass[] = {
    {0, 0, 0, 100, 3600},
};
inline constexpr StyleEvent kEndChord[] = {
    {0, 0, 0, 85, 3600}, {0, 1, 0, 85, 3600}, {0, 2, 0, 85, 3600}, {0, 3, 0, 85, 3600},
};
