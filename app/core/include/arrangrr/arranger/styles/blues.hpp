...
inline constexpr StyleEvent kArpTrip[] = {
    {.step=0, .tone=kRoot, .octave=0, .vel=62, .gate=kGateHat}, {.step=3, .tone=kFifth, .octave=0, .vel=50, .gate=kGateHat}, {.step=4, .tone=kThird, .octave=0, .vel=56, .gate=kGateHat}, {.step=7, .tone=kSeventh, .octave=0, .vel=50, .gate=kGateHat},
    {.step=8, .tone=kFifth, .octave=0, .vel=60, .gate=kGateHat}, {.step=11, .tone=kRoot, .octave=1, .vel=54, .gate=kGateHat}, {.step=12, .tone=kSeventh, .octave=0, .vel=56, .gate=kGateHat}, {.step=15, .tone=kThird, .octave=1, .vel=50, .gate=kGateHat},
};
...
inline constexpr Style kStyle{.name="blues", .sections=Span<const StyleSection>(kSections), .tempo=6600};
}  // namespace blues
