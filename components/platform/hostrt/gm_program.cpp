...
// General MIDI Level 2 percussion-kit map (channel 10 Program Change): the
// canonical bank-128 preset numbers most GM soundfonts implement.
constexpr std::array<GmDrumKit, 9> kGmDrumKits = {{
...
const char* gm_drum_kit_name(std::uint8_t program) {
  for (const GmDrumKit& kit : kGmDrumKits) {
