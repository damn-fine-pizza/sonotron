...
inline constexpr StyleEvent kBBPeak[] = {
    {.step=0, .tone=kRoot, .octave=0, .vel=115, .gate=kGateStaccato}, {.step=1, .tone=kRoot, .octave=0, .vel=46, .gate=kGateStaccato}, {.step=2, .tone=kRoot, .octave=1, .vel=92, .gate=kGateStaccato}, {.step=3, .tone=kRoot, .octave=0, .vel=94, .gate=kGateStaccato}, {.step=6, .tone=kFifth, .octave=0, .vel=98, .gate=kGateStaccato}, {.step=7, .tone=kRoot, .octave=0, .vel=48, .gate=kGateStaccato}, {.step=8, .tone=kRoot, .octave=0, .vel=104, .gate=kGateStaccato}, {.step=10, .tone=kSeventh, .octave=0, .vel=96, .gate=kGateStaccato}, {.step=11, .tone=kRoot, .octave=1, .vel=90, .gate=kGateStaccato}, {.step=13, .tone=kRoot, .octave=0, .vel=46, .gate=kGateStaccato}, {.step=14, .tone=kFifth, .octave=0, .vel=94, .gate=kGateStaccato},
};
...
inline constexpr StylePattern kDP[] = {{.role=TrackRole::kDrums, .policy=RolePolicy::kFixed, .events=Span<const StyleEvent>(kDD), .motif=&kPeakDrumsMotif}, {.role=TrackRole::kBass, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kBBPeak)}, {.role=TrackRole::kChord1, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kDC), .motif=&kPeakChordMotif},
