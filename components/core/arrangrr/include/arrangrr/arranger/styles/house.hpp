...
// VarB's own kBB.
inline constexpr StyleEvent kBBPeak[] = {{.step=2, .tone=kRoot, .octave=0, .vel=104, .gate=kGate8th}, {.step=2, .tone=kRoot, .octave=-1, .vel=70, .gate=kGate8th}, {.step=6, .tone=kThird, .octave=0, .vel=96, .gate=kGate8th}, {.step=8, .tone=kFifth, .octave=0, .vel=98, .gate=kGate8th}, {.step=10, .tone=kFifth, .octave=0, .vel=94, .gate=kGate8th}, {.step=14, .tone=kSeventh, .octave=0, .vel=96, .gate=kGate8th}};
