...
inline constexpr StyleEvent kBoogieBassPeak[] = {
    ...
    {.step=12, .tone=3, .octave=-1, .vel=84, .gate=kGateStaccato, .src=NoteSource::kInterval},  // b3
    {.step=13, .tone=2, .octave=-1, .vel=82, .gate=kGateStaccato, .src=NoteSource::kInterval},
    {.step=14, .tone=1, .octave=-1, .vel=80, .gate=kGateStaccato, .src=NoteSource::kInterval},
    {.step=15, .tone=0, .octave=-1, .vel=78, .gate=kGateStaccato, .src=NoteSource::kInterval},  // lands on the root, into the repeat
};
...
inline constexpr StylePattern kDP[] = {{.role=TrackRole::kDrums, .policy=RolePolicy::kFixed, .events=Span<const StyleEvent>(kDD), .motif=&kPeakDrumsMotif}, {.role=TrackRole::kBass, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kBoogieBassPeak), .motif=&kBoogieBassMotif}, {.role=TrackRole::kChord1, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kDC), .voicing=VoicingPolicy::kLead, .motif=&kPeakChordMotif}, {.role=TrackRole::kPad, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kPad7), .gm_program=kPadVoice, .voicing=VoicingPolicy::kLead, .motif=&kSharedPadMotif}, {.role=TrackRole::kChord2, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kOrganComp), .gm_program=kChord2Voice, .voicing=VoicingPolicy::kLead, .motif=&kSharedChord2Motif}, {.role=TrackRole::kArp, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kArpTrip), .gm_program=kArpVoice}, {.role=TrackRole::kLead, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kLeadLick), .gm_program=kLeadVoice, .motif=&kLeadLickMotif}, {.role=TrackRole::kPerc, .policy=RolePolicy::kFixed, .events=Span<const StyleEvent>(kPercTamb)}};
