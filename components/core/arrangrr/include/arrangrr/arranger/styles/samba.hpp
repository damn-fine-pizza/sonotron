...
inline constexpr StyleEvent kSyncBass[] = {
    {.step = 0, .tone = kRoot, .octave = 0, .vel = 96, .gate = kGate8th},
    {.step = 4, .tone = kFifth, .octave = -1, .vel = 100, .gate = kGate8th},
    {.step = 6, .tone = kRoot, .octave = 0, .vel = 84, .gate = kGateStaccato},
    {.step = 8, .tone = kRoot, .octave = 0, .vel = 92, .gate = kGate8th},
    {.step = 12, .tone = kFifth, .octave = -1, .vel = 100, .gate = kGate8th},
    {.step = 14, .tone = kRoot, .octave = 0, .vel = 84, .gate = kGateStaccato}};
...
inline constexpr StyleEvent kChord2Sync[] = {
    {.step = 3, .tone = kThird, .octave = 0, .vel = 62, .gate = kGateStaccato},
    ...
    {.step = 11, .tone = kThird, .octave = 0, .vel = 62, .gate = kGateStaccato},
    {.step = 11, .tone = kSeventh, .octave = 0, .vel = 62, .gate = kGateStaccato},
    {.step = 15, .tone = kFifth, .octave = 0, .vel = 58, .gate = kGateStaccato},
    {.step = 15, .tone = kSeventh, .octave = 0, .vel = 58, .gate = kGateStaccato}};
inline constexpr StyleEvent kChord2Off[] = {
    {.step = 1, .tone = kThird, .octave = 0, .vel = 60, .gate = kGateStaccato},
    {.step = 1, .tone = kSeventh, .octave = 0, .vel = 60, .gate = kGateStaccato},
    {.step = 3, .tone = kFifth, .octave = 0, .vel = 58, .gate = kGateStaccato},
    {.step = 3, .tone = kSeventh, .octave = 0, .vel = 58, .gate = kGateStaccato},
    {.step = 7, .tone = kThird, .octave = 0, .vel = 60, .gate = kGateStaccato},
    {.step = 7, .tone = kSeventh, .octave = 0, .vel = 60, .gate = kGateStaccato},
    {.step = 9, .tone = kFifth, .octave = 0, .vel = 58, .gate = kGateStaccato},
    {.step = 9, .tone = kSeventh, .octave = 0, .vel = 58, .gate = kGateStaccato},
...
inline constexpr StyleEvent kArp8[] = {
    ...
    {.step = 2, .tone = kFifth, .octave = 0, .vel = 56, .gate = kGateHat},
    {.step = 4, .tone = kThird, .octave = 0, .vel = 60, .gate = kGateHat},
    {.step = 6, .tone = kSeventh, .octave = 0, .vel = 56, .gate = kGateHat},
    {.step = 8, .tone = kRoot, .octave = 1, .vel = 62, .gate = kGateHat},
    {.step = 10, .tone = kFifth, .octave = 0, .vel = 56, .gate = kGateHat},
    {.step = 12, .tone = kThird, .octave = 1, .vel = 60, .gate = kGateHat},
    {.step = 14, .tone = kSeventh, .octave = 0, .vel = 56, .gate = kGateHat}};
inline constexpr StyleEvent kPercShake[] = {
    {.step = 0, .tone = kMaracas, .octave = 0, .vel = 56, .gate = kGateHat},
    {.step = 2, .tone = kMaracas, .octave = 0, .vel = 46, .gate = kGateHat},
    {.step = 4, .tone = kMaracas, .octave = 0, .vel = 56, .gate = kGateHat},
    {.step = 6, .tone = kMaracas, .octave = 0, .vel = 46, .gate = kGateHat},
    {.step = 8, .tone = kMaracas, .octave = 0, .vel = 56, .gate = kGateHat},
    {.step = 10, .tone = kMaracas, .octave = 0, .vel = 46, .gate = kGateHat},
    {.step = 12, .tone = kMaracas, .octave = 0, .vel = 56, .gate = kGateHat},
    {.step = 14, .tone = kMaracas, .octave = 0, .vel = 46, .gate = kGateHat}};
inline constexpr StyleEvent kPercRich[] = {
    {.step = 0, .tone = kShortGuiro, .octave = 0, .vel = 62, .gate = kGateHat},
    {.step = 4, .tone = kShortGuiro, .octave = 0, .vel = 58, .gate = kGateHat},
    {.step = 8, .tone = kShortGuiro, .octave = 0, .vel = 62, .gate = kGateHat},
    {.step = 12, .tone = kShortGuiro, .octave = 0, .vel = 58, .gate = kGateHat},
    {.step = 2, .tone = kCowbell, .octave = 0, .vel = 54, .gate = kGateHat},
    {.step = 6, .tone = kCowbell, .octave = 0, .vel = 50, .gate = kGateHat},
    {.step = 10, .tone = kCowbell, .octave = 0, .vel = 54, .gate = kGateHat},
    {.step = 14, .tone = kCowbell, .octave = 0, .vel = 50, .gate = kGateHat}};
...
inline constexpr StyleEvent kIn1D[] = {
    {.step = 8, .tone = kHiAgogo, .octave = 0, .vel = 70, .gate = 50},
    {.step = 10, .tone = kLoAgogo, .octave = 0, .vel = 64, .gate = 50},
    {.step = 12, .tone = kHiAgogo, .octave = 0, .vel = 76, .gate = 50},
    {.step = 14, .tone = kLoAgogo, .octave = 0, .vel = 80, .gate = 50},
    // bar 2: arrival -- surdo kick lands on the backbeat, agogo fills in.
    {.step = 16, .tone = kHiAgogo, .octave = 0, .vel = 72, .gate = 50},
    {.step = 18, .tone = kLoAgogo, .octave = 0, .vel = 64, .gate = 50},
    {.step = 20, .tone = kKick, .octave = 0, .vel = 100, .gate = 50},
    {.step = 22, .tone = kHiAgogo, .octave = 0, .vel = 76, .gate = 50},
    {.step = 24, .tone = kLoAgogo, .octave = 0, .vel = 68, .gate = 50},
    {.step = 26, .tone = kHiAgogo, .octave = 0, .vel = 80, .gate = 50},
    {.step = 28, .tone = kKick, .octave = 0, .vel = 104, .gate = 50},
    {.step = 30, .tone = kLoAgogo, .octave = 0, .vel = 84, .gate = 50},
};
...
inline constexpr StyleEvent kIn2D[] = {
    {.step = 4, .tone = kKick, .octave = 0, .vel = 100, .gate = 50},
    {.step = 12, .tone = kKick, .octave = 0, .vel = 104, .gate = 50},
...
inline constexpr StylePattern kIn2P[] = {{.role = TrackRole::kDrums,
                                         ...
                                         {.role = TrackRole::kBass,
                                          .policy = RolePolicy::kChordTone,
                                          .events = Span<const StyleEvent>(kSyncBass)},
...
inline constexpr StyleEvent kAD[] = {
    {.step = 4, .tone = kKick, .octave = 0, .vel = 108, .gate = 50},
    {.step = 12, .tone = kKick, .octave = 0, .vel = 112, .gate = 50},
    {.step = 0, .tone = kKick, .octave = 0, .vel = 76, .gate = 50},
    {.step = 8, .tone = kKick, .octave = 0, .vel = 76, .gate = 50},
    {.step = 0, .tone = kTambourine, .octave = 0, .vel = 64, .gate = 50},
    {.step = 1, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 2, .tone = kTambourine, .octave = 0, .vel = 58, .gate = 50},
    {.step = 3, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 4, .tone = kTambourine, .octave = 0, .vel = 64, .gate = 50},
    {.step = 5, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 6, .tone = kTambourine, .octave = 0, .vel = 58, .gate = 50},
    {.step = 7, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 8, .tone = kTambourine, .octave = 0, .vel = 64, .gate = 50},
    {.step = 9, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 10, .tone = kTambourine, .octave = 0, .vel = 58, .gate = 50},
    {.step = 11, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 12, .tone = kTambourine, .octave = 0, .vel = 64, .gate = 50},
    {.step = 13, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 14, .tone = kTambourine, .octave = 0, .vel = 58, .gate = 50},
    {.step = 15, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 0, .tone = kHiAgogo, .octave = 0, .vel = 72, .gate = 50},
    {.step = 3, .tone = kLoAgogo, .octave = 0, .vel = 64, .gate = 50},
    {.step = 6, .tone = kHiAgogo, .octave = 0, .vel = 68, .gate = 50},
    {.step = 8, .tone = kHiAgogo, .octave = 0, .vel = 72, .gate = 50},
    {.step = 11, .tone = kLoAgogo, .octave = 0, .vel = 64, .gate = 50},
    {.step = 14, .tone = kHiAgogo, .octave = 0, .vel = 68, .gate = 50},
    ...
    {.step = 20, .tone = kKick, .octave = 0, .vel = 112, .gate = 50},
    {.step = 28, .tone = kKick, .octave = 0, .vel = 116, .gate = 50},
    {.step = 16, .tone = kKick, .octave = 0, .vel = 84, .gate = 50},
    {.step = 24, .tone = kKick, .octave = 0, .vel = 84, .gate = 50},
    {.step = 16, .tone = kTambourine, .octave = 0, .vel = 64, .gate = 50},
    {.step = 17, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 18, .tone = kTambourine, .octave = 0, .vel = 58, .gate = 50},
    {.step = 19, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 20, .tone = kTambourine, .octave = 0, .vel = 64, .gate = 50},
    {.step = 21, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 22, .tone = kTambourine, .octave = 0, .vel = 58, .gate = 50},
    {.step = 23, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 24, .tone = kTambourine, .octave = 0, .vel = 64, .gate = 50},
    {.step = 25, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 26, .tone = kTambourine, .octave = 0, .vel = 58, .gate = 50},
    {.step = 27, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 28, .tone = kTambourine, .octave = 0, .vel = 64, .gate = 50},
    {.step = 29, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 30, .tone = kTambourine, .octave = 0, .vel = 58, .gate = 50},
    {.step = 31, .tone = kTambourine, .octave = 0, .vel = 48, .gate = 50},
    {.step = 16, .tone = kLoAgogo, .octave = 0, .vel = 68, .gate = 50},
    {.step = 19, .tone = kHiAgogo, .octave = 0, .vel = 72, .gate = 50},
    {.step = 22, .tone = kLoAgogo, .octave = 0, .vel = 70, .gate = 50},
    {.step = 24, .tone = kLoAgogo, .octave = 0, .vel = 68, .gate = 50},
    {.step = 27, .tone = kHiAgogo, .octave = 0, .vel = 76, .gate = 50},
    {.step = 30, .tone = kHiAgogo, .octave = 0, .vel = 82, .gate = 50},
    {.step = 31, .tone = kLoAgogo, .octave = 0, .vel = 78, .gate = 50},
};
...
inline constexpr StyleEvent kBD[] = {
    {.step = 4, .tone = kKick, .octave = 0, .vel = 112, .gate = 50},
    {.step = 12, .tone = kKick, .octave = 0, .vel = 116, .gate = 50},
    {.step = 0, .tone = kKick, .octave = 0, .vel = 84, .gate = 50},
    {.step = 8, .tone = kKick, .octave = 0, .vel = 84, .gate = 50},
    {.step = 7, .tone = kKick, .octave = 0, .vel = 70, .gate = 50},
    {.step = 15, .tone = kKick, .octave = 0, .vel = 70, .gate = 50},
    {.step = 0, .tone = kTambourine, .octave = 0, .vel = 66, .gate = 50},
    {.step = 1, .tone = kTambourine, .octave = 0, .vel = 50, .gate = 50},
    {.step = 2, .tone = kTambourine, .octave = 0, .vel = 60, .gate = 50},
    {.step = 3, .tone = kTambourine, .octave = 0, .vel = 50, .gate = 50},
    {.step = 4, .tone = kTambourine, .octave = 0, .vel = 66, .gate = 50},
    {.step = 5, .tone = kTambourine, .octave = 0, .vel = 50, .gate = 50},
    {.step = 6, .tone = kTambourine, .octave = 0, .vel = 60, .gate = 50},
    {.step = 7, .tone = kTambourine, .octave = 0, .vel = 50, .gate = 50},
    {.step = 8, .tone = kTambourine, .octave = 0, .vel = 66, .gate = 50},
    {.step = 9, .tone = kTambourine, .octave = 0, .vel = 50, .gate = 50},
    {.step = 10, .tone = kTambourine, .octave = 0, .vel = 60, .gate = 50},
    {.step = 11, .tone = kTambourine, .octave = 0, .vel = 50, .gate = 50},
    {.step = 12, .tone = kTambourine, .octave = 0, .vel = 66, .gate = 50},
    {.step = 13, .tone = kTambourine, .octave = 0, .vel = 50, .gate = 50},
    {.step = 14, .tone = kTambourine, .octave = 0, .vel = 60, .gate = 50},
    {.step = 15, .tone = kTambourine, .octave = 0, .vel = 50, .gate = 50},
    {.step = 2, .tone = kOpenHiConga, .octave = 0, .vel = 70, .gate = 50},
    {.step = 6, .tone = kLoConga, .octave = 0, .vel = 72, .gate = 50},
    {.step = 10, .tone = kOpenHiConga, .octave = 0, .vel = 70, .gate = 50},
    {.step = 14, .tone = kLoConga, .octave = 0, .vel = 74, .gate = 50},
};
inline constexpr StyleEvent kBC[] = {{.step = 0,
                                      .tone = kRoot,
                                      .octave = 0,
                                      .vel = 82,
                                      .gate = kGateStaccato,
...
inline constexpr StyleEvent kFAD[] = {
    {.step = 0, .tone = kKick, .octave = 0, .vel = 100, .gate = 50},
    {.step = 4, .tone = kTomHi, .octave = 0, .vel = 90, .gate = 100},
    {.step = 6, .tone = kTomHi, .octave = 0, .vel = 86, .gate = 100},
    {.step = 8, .tone = kTomMid, .octave = 0, .vel = 94, .gate = 100},
    {.step = 10, .tone = kTomMid, .octave = 0, .vel = 90, .gate = 100},
...
inline constexpr StyleEvent kFBD[] = {
    ...
    {.step = 8, .tone = kTomLow, .octave = 0, .vel = 98, .gate = 100},
    {.step = 10, .tone = kTomLow, .octave = 0, .vel = 94, .gate = 100},
    {.step = 12, .tone = kTomFloor, .octave = 0, .vel = 104, .gate = 100},
    {.step = 14, .tone = kTomFloor, .octave = 0, .vel = 108, .gate = 100}};
inline constexpr StyleEvent kFCD[] = {
    {.step = 0, .tone = kOpenHiConga, .octave = 0, .vel = 88, .gate = 50},
    {.step = 2, .tone = kLoConga, .octave = 0, .vel = 84, .gate = 50},
    {.step = 4, .tone = kOpenHiConga, .octave = 0, .vel = 90, .gate = 50},
    {.step = 6, .tone = kLoConga, .octave = 0, .vel = 86, .gate = 50},
...
inline constexpr StyleEvent kFDD[] = {
    {.step = 0, .tone = kTomHi, .octave = 0, .vel = 90, .gate = 50},
    {.step = 1, .tone = kTomHi, .octave = 0, .vel = 86, .gate = 50},
    {.step = 2, .tone = kTomMid, .octave = 0, .vel = 92, .gate = 50},
    {.step = 3, .tone = kTomMid, .octave = 0, .vel = 88, .gate = 50},
    {.step = 4, .tone = kTomLow, .octave = 0, .vel = 96, .gate = 50},
    {.step = 5, .tone = kTomLow, .octave = 0, .vel = 92, .gate = 50},
    {.step = 6, .tone = kTomFloor, .octave = 0, .vel = 100, .gate = 50},
    {.step = 7, .tone = kTomFloor, .octave = 0, .vel = 96, .gate = 50},
    {.step = 8, .tone = kSnare, .octave = 0, .vel = 102, .gate = 50},
    {.step = 9, .tone = kSnare, .octave = 0, .vel = 98, .gate = 50},
    {.step = 10, .tone = kSnare, .octave = 0, .vel = 104, .gate = 50},
    {.step = 11, .tone = kSnare, .octave = 0, .vel = 100, .gate = 50},
    {.step = 12, .tone = kSnare, .octave = 0, .vel = 108, .gate = 50},
...
inline constexpr StylePattern kFDP[] = {{.role = TrackRole::kDrums,
                                        ...
                                        {.role = TrackRole::kPerc,
                                         .policy = RolePolicy::kFixed,
                                         .events = Span<const StyleEvent>(kPercRich)}};
inline constexpr StyleEvent kE1D[] = {
    {.step = 0, .tone = kCrash, .octave = 0, .vel = 100, .gate = kGateHalfBar},
    {.step = 0, .tone = kKick, .octave = 0, .vel = 104, .gate = 50},
    {.step = 8, .tone = kKick, .octave = 0, .vel = 96, .gate = 50},
    // bar 2 (breque, ending): the crash arrives on the downbeat; an
    // accelerating kick pickup closes out the bar (shifted to stay inside
    // bar 2's own step range rather than crossing into bar 1).
    {.step = 16, .tone = kCrash, .octave = 0, .vel = 110, .gate = kGateHeld},
    {.step = 28, .tone = kKick, .octave = 0, .vel = 100, .gate = 50},
    {.step = 29, .tone = kKick, .octave = 0, .vel = 104, .gate = 50},
    {.step = 30, .tone = kKick, .octave = 0, .vel = 108, .gate = 50},
    {.step = 31, .tone = kKick, .octave = 0, .vel = 112, .gate = 50},
};
inline constexpr StyleEvent kE1B[] = {
    {.step = 0, .tone = kRoot, .octave = 0, .vel = 100, .gate = kGateHeld},
    // bar 2: the root triad stab lands on the downbeat, held.
...
inline constexpr StyleEvent kE1C[] = {
    ...
    // bar 2: the root triad stab, doubling the bass hit above.
...
inline constexpr StyleEvent kE2D[] = {
    ...
    {.step = 0, .tone = kKick, .octave = 0, .vel = 108, .gate = 50},
    {.step = 4, .tone = kKick, .octave = 0, .vel = 100, .gate = 50},
    {.step = 8, .tone = kKick, .octave = 0, .vel = 104, .gate = 50},
    {.step = 12, .tone = kKick, .octave = 0, .vel = 100, .gate = 50},
    // bar 2 (breque, ending2): the same accelerating pickup, but the arrival
    // is a split hit -- half the kit here, the agogo answering call-response
    // (see kE2Perc below).
    {.step = 16, .tone = kCrash, .octave = 0, .vel = 112, .gate = kGateHeld},
    {.step = 16, .tone = kKick, .octave = 0, .vel = 110, .gate = 50},
    {.step = 28, .tone = kKick, .octave = 0, .vel = 104, .gate = 50},
    {.step = 29, .tone = kKick, .octave = 0, .vel = 108, .gate = 50},
    {.step = 30, .tone = kKick, .octave = 0, .vel = 112, .gate = 50},
    {.step = 31, .tone = kKick, .octave = 0, .vel = 116, .gate = 50},
};
// The split hit's other half: agogo answers the drums' step-16 arrival.
inline constexpr StyleEvent kE2Perc[] = {
    {.step = 18, .tone = kHiAgogo, .octave = 0, .vel = 90, .gate = kGateHat},
    {.step = 18, .tone = kLoAgogo, .octave = 0, .vel = 86, .gate = kGateHat},
};
inline constexpr StyleEvent kE2B[] = {
    {.step = 0, .tone = kRoot, .octave = -1, .vel = 104, .gate = kGateHeld},
    {.step = 0, .tone = kRoot, .octave = 0, .vel = 94, .gate = kGateHeld},
    // bar 2: a short root stab on the downbeat, then bass drops out (only
    // Chord1 carries the vamp-out tag below).
    {.step = 16, .tone = kRoot, .octave = 0, .vel = 98, .gate = kGateBeat},
};
inline constexpr StyleEvent kE2C[] = {
    ...
    // bar 2: a short root triad stab on the downbeat, then a repeated
    // eighth-note vamp-out tag (rhythmic, not harmonic) fading before the cut.
    {.step = 16, .tone = kRoot, .octave = 0, .vel = 88, .gate = kGateBeat},
    {.step = 16, .tone = kThird, .octave = 0, .vel = 88, .gate = kGateBeat},
    {.step = 16, .tone = kFifth, .octave = 0, .vel = 88, .gate = kGateBeat},
    {.step = 24, .tone = kRoot, .octave = 0, .vel = 80, .gate = kGate8th},
    {.step = 26, .tone = kThird, .octave = 0, .vel = 76, .gate = kGate8th},
    {.step = 28, .tone = kFifth, .octave = 0, .vel = 74, .gate = kGate8th},
    {.step = 30, .tone = kRoot, .octave = 0, .vel = 70, .gate = kGate8th},
};
...
// ---------------------------------------------------------------------------
// varBreak (breque, A.5 break): the genre's own named stop-time convention --
// silence, then a syncopated unison stop landing off the downbeat (no
// dedicated surdo constant beyond kKick in this file, so kKick stands in as
// the low-drum voice), then a short agogo tag leading back into the groove.
inline constexpr StyleEvent kBrkD[] = {
    {.step = 3, .tone = kKick, .octave = 0, .vel = 118, .gate = kGateStab},
    {.step = 3, .tone = kCrash, .octave = 0, .vel = 110, .gate = kGateStab},
    {.step = 12, .tone = kHiAgogo, .octave = 0, .vel = 90, .gate = kGateHat},
    {.step = 14, .tone = kLoAgogo, .octave = 0, .vel = 95, .gate = kGateHat},
};
inline constexpr StyleEvent kBrkB[] = {
    {.step = 3, .tone = kRoot, .octave = 0, .vel = 100, .gate = kGateStab}};
inline constexpr StyleEvent kBrkC[] = {
    {.step = 3, .tone = kRoot, .octave = 0, .vel = 96, .gate = kGateStab},
    {.step = 3, .tone = kThird, .octave = 0, .vel = 96, .gate = kGateStab},
    {.step = 3, .tone = kFifth, .octave = 0, .vel = 96, .gate = kGateStab},
};
...
inline constexpr StyleEvent kDD[] = {
    {.step = 4, .tone = kKick, .octave = 0, .vel = 114, .gate = 50},
    {.step = 12, .tone = kKick, .octave = 0, .vel = 118, .gate = 50},
    {.step = 0, .tone = kKick, .octave = 0, .vel = 84, .gate = 50},
    {.step = 8, .tone = kKick, .octave = 0, .vel = 84, .gate = 50},
    {.step = 7, .tone = kKick, .octave = 0, .vel = 70, .gate = 50},
    {.step = 15, .tone = kKick, .octave = 0, .vel = 70, .gate = 50},
    ...
    {.step = 6, .tone = kLoConga, .octave = 0, .vel = 74, .gate = 50},
    {.step = 10, .tone = kOpenHiConga, .octave = 0, .vel = 72, .gate = 50},
    {.step = 14, .tone = kLoConga, .octave = 0, .vel = 76, .gate = 50},
    {.step = 0, .tone = kHiAgogo, .octave = 0, .vel = 74, .gate = 50},
    {.step = 8, .tone = kHiAgogo, .octave = 0, .vel = 74, .gate = 50},
    // varD peak drums (item 7): a real caixa ghost-stroke layer -- a snare
    // voice not present anywhere else in this section's drums -- at 3 spots
    // that dodge the kick onsets (0, 4, 7, 8, 12, 15), a genuine samba
    // "virada" push under the surdo/tamborim/agogo bed above.
    {.step = 3, .tone = kSnare, .octave = 0, .vel = 42, .gate = kGateStaccato},
    {.step = 9, .tone = kSnare, .octave = 0, .vel = 46, .gate = kGateStaccato},
    {.step = 13, .tone = kSnare, .octave = 0, .vel = 44, .gate = kGateStaccato},
};
inline constexpr StyleEvent kDC[] = {{.step = 0,
                                      .tone = kRoot,
                                      .octave = 0,
                                      .vel = 84,
                                      .gate = kGateStaccato,
...
inline constexpr Style kStyle{.name = "samba",
