...
inline constexpr StyleEvent kTumbaoPeak[] = {
    {.step=6, .tone=kFifth, .octave=-1, .vel=98, .gate=kGate8th}, {.step=6, .tone=kFifth, .octave=0, .vel=70, .gate=kGateStaccato},
    {.step=8, .tone=kSeventh, .octave=-1, .vel=88, .gate=kGateStab}, {.step=12, .tone=kRoot, .octave=0, .vel=100, .gate=kGate8th}, {.step=14, .tone=kFifth, .octave=-1, .vel=90, .gate=kGateStab}, {.step=0, .tone=kRoot, .octave=-1, .vel=86, .gate=kGateStab},
    {.step=22, .tone=kFifth, .octave=-1, .vel=98, .gate=kGate8th}, {.step=24, .tone=kSeventh, .octave=-1, .vel=88, .gate=kGateStab}, {.step=28, .tone=kRoot, .octave=0, .vel=100, .gate=kGate8th}, {.step=30, .tone=kFifth, .octave=-1, .vel=90, .gate=kGateStab}, {.step=16, .tone=kRoot, .octave=-1, .vel=86, .gate=kGateStab},
};
...
inline constexpr StylePattern kIn2P[] = {{.role=TrackRole::kDrums, .policy=RolePolicy::kFixed, .events=Span<const StyleEvent>(kIn2D)}, {.role=TrackRole::kBass, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kTumbao)}, {.role=TrackRole::kChord1, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kIn2C)}, {.role=TrackRole::kPad, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kPad7), .gm_program=kPadVoice, .voicing=VoicingPolicy::kLead, .motif=&kSharedPadMotif}, {.role=TrackRole::kPerc, .policy=RolePolicy::kFixed, .events=Span<const StyleEvent>(kClave)}};
...
inline constexpr StylePattern kE1P[] = {{.role=TrackRole::kDrums, .policy=RolePolicy::kFixed, .events=Span<const StyleEvent>(kE1D)}, {.role=TrackRole::kBass, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kE1B)}, {.role=TrackRole::kChord1, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kE1C)}, {.role=TrackRole::kPad, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kPad7), .gm_program=kPadVoice, .voicing=VoicingPolicy::kLead, .motif=&kSharedPadMotif}};
...
inline constexpr StylePattern kE2P[] = {{.role=TrackRole::kDrums, .policy=RolePolicy::kFixed, .events=Span<const StyleEvent>(kE2D)}, {.role=TrackRole::kBass, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kE2B)}, {.role=TrackRole::kChord1, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kE2C)}, {.role=TrackRole::kPad, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kPad7), .gm_program=kPadVoice, .voicing=VoicingPolicy::kLead, .motif=&kSharedPadMotif}};
...
inline constexpr StylePattern kCP[] = {{.role=TrackRole::kDrums, .policy=RolePolicy::kFixed, .events=Span<const StyleEvent>(kCD)}, {.role=TrackRole::kBass, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kTumbao)}, {.role=TrackRole::kChord1, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kCC)}, {.role=TrackRole::kPad, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kPad7), .gm_program=kPadVoice, .voicing=VoicingPolicy::kLead, .motif=&kSharedPadMotif}, {.role=TrackRole::kChord2, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kNylon), .gm_program=kChord2Voice, .motif=&kSharedChord2Motif}, {.role=TrackRole::kArp, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kHarp), .gm_program=kArpVoice}, {.role=TrackRole::kPerc, .policy=RolePolicy::kFixed, .events=Span<const StyleEvent>(kPercC)}};
...
inline constexpr StyleEvent kDDPeak[] = {
    {.step=0,  .tone=kCowbell, .octave=0, .vel=90, .gate=50}, {.step=1,  .tone=kCowbell, .octave=0, .vel=64, .gate=50},
    {.step=2,  .tone=kCowbell, .octave=0, .vel=88, .gate=50}, {.step=3,  .tone=kCowbell, .octave=0, .vel=62, .gate=50},
    {.step=4,  .tone=kCowbell, .octave=0, .vel=90, .gate=50}, {.step=5,  .tone=kCowbell, .octave=0, .vel=64, .gate=50},
    {.step=6,  .tone=kCowbell, .octave=0, .vel=88, .gate=50}, {.step=7,  .tone=kCowbell, .octave=0, .vel=62, .gate=50},
    {.step=8,  .tone=kCowbell, .octave=0, .vel=90, .gate=50}, {.step=9,  .tone=kCowbell, .octave=0, .vel=64, .gate=50},
    {.step=10, .tone=kCowbell, .octave=0, .vel=88, .gate=50}, {.step=11, .tone=kCowbell, .octave=0, .vel=62, .gate=50},
    {.step=12, .tone=kCowbell, .octave=0, .vel=90, .gate=50}, {.step=13, .tone=kCowbell, .octave=0, .vel=64, .gate=50},
    {.step=14, .tone=kCowbell, .octave=0, .vel=88, .gate=50}, {.step=15, .tone=kCowbell, .octave=0, .vel=62, .gate=50},
    {.step=0, .tone=kLoConga, .octave=0, .vel=72, .gate=50}, {.step=2, .tone=kOpenHiConga, .octave=0, .vel=76, .gate=50}, {.step=3, .tone=kOpenHiConga, .octave=0, .vel=70, .gate=50}, {.step=6, .tone=kLoConga, .octave=0, .vel=78, .gate=50}, {.step=8, .tone=kOpenHiConga, .octave=0, .vel=74, .gate=50}, {.step=10, .tone=kOpenHiConga, .octave=0, .vel=76, .gate=50}, {.step=11, .tone=kOpenHiConga, .octave=0, .vel=70, .gate=50}, {.step=14, .tone=kLoConga, .octave=0, .vel=80, .gate=50}, {.step=4, .tone=kHiTimbale, .octave=0, .vel=70, .gate=50}, {.step=7, .tone=kLoTimbale, .octave=0, .vel=64, .gate=50}, {.step=12, .tone=kHiTimbale, .octave=0, .vel=70, .gate=50}, {.step=15, .tone=kLoTimbale, .octave=0, .vel=66, .gate=50},
};
...
inline constexpr StylePattern kDP[] = {{.role=TrackRole::kDrums, .policy=RolePolicy::kFixed, .events=Span<const StyleEvent>(kDDPeak)}, {.role=TrackRole::kBass, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kTumbaoPeak)}, {.role=TrackRole::kChord1, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kDC), .motif=&kPeakChordMotif}, {.role=TrackRole::kPad, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kPad7), .gm_program=kPadVoice, .voicing=VoicingPolicy::kLead, .motif=&kSharedPadMotif}, {.role=TrackRole::kChord2, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kNylon), .gm_program=kChord2Voice, .motif=&kSharedChord2Motif}, {.role=TrackRole::kArp, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kHarp), .gm_program=kArpVoice}, {.role=TrackRole::kLead, .policy=RolePolicy::kChordTone, .events=Span<const StyleEvent>(kMamboHorn), .gm_program=kLeadVoice, .motif=&kMamboHornMotif}, {.role=TrackRole::kPerc, .policy=RolePolicy::kFixed, .events=Span<const StyleEvent>(kPercD)}};
